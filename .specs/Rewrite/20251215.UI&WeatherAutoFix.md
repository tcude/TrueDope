...
1. **UI Text Change**: "Create Chrono Session" should say "Add Chrono Session" (consistent with Groups/DOPE)
...
### Issue 1: Button Text
- [x] Change "Create Chrono Session" to "Add Chrono Session" in header (ChronoTab.tsx:213)
- [x] Change "Create Chrono Session" to "Add Chrono Session" in button (ChronoTab.tsx:278)
- [x] Change "Creating..." to "Adding..." in button loading state (ChronoTab.tsx:278)
...
1. **Button Text**: Navigate to a session edit page, go to Chrono tab (without existing chrono), verify text says "Add Chrono Session"
