...
public interface IAnalyticsService
{
    ...
    Task<AmmoComparisonDto> GetAmmoComparisonAsync(string userId, AmmoComparisonFilterDto filter);
    Task<LotComparisonDto> GetLotComparisonAsync(string userId, LotComparisonFilterDto filter);
