    ...
    <div>
      {!readOnly && (
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-medium text-gray-900">Group Entries</h3>
      ...
      {sortedEntries.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          <p className="text-gray-500 mb-4">No groups recorded yet.</p>
          {!readOnly && (
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full h-10 px-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="flex items-center gap-2 text-sm">
                <span className={formData.sizeInputMode === 'inches' ? 'font-medium' : 'text-gray-500'}>
                  Inches
                </span>
                <button
                  type="button"
                  ...
                  className="relative inline-flex h-5 w-9 items-center rounded-full bg-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <span
                ...
                <span className={formData.sizeInputMode === 'moa' ? 'font-medium' : 'text-gray-500'}>
                  MOA
                </span>
              </div>
            </div>
